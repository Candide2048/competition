...
# 帆型安装台数 — 等面积归一化（≈750 m² 总投影面积）
# 为公平对比三种帆型的「单位面积气动效率」而非安装规模差异，
# 将三者归一化到相近总投影面积（Flettner 8×96=768, 翼帆 1×750,
# 吸力帆 11×66=726 m²）。避免大面积翼帆在强风时段推力饱和（T≥R_total）
# 导致的节油率虚高（原 4×750=3000 m² 会使翼帆 >30%，远超文献 7-14%）。
# 实船满装潜力另见申报书（如 New Aden VLCC 4×1200 m² → 9.8%）。
SAIL_INSTALL = {
    "flettner": 8,
    "rigid_wing": 1,
    "suction_wing": 11,
